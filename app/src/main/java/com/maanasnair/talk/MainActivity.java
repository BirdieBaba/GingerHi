...
import com.maanasnair.talk.home.HomeFragment;
import com.maanasnair.talk.meeting_history.MeetingHistoryFragment;
import com.maanasnair.talk.schedule.ScheduleFragment;
import com.maanasnair.talk.settings.SettingsFragment;
        ...
        try {
            ...
            materialAlertDialogBuilder.setCancelable(false).setPositiveButton(getResources().getString(R.string.update_now), new DialogInterface.OnClickListener() {
                ...
                public void onClick(DialogInterface dialog, int which) {
                    dialog.dismiss();
                    startActivity(new Intent(Intent.ACTION_VIEW, Uri.parse("https://play.google.com/store/apps/details?id=com.maanasnair.talk")));
                }
            });
